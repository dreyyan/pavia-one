export const gradeLevelOptions = ["7", "8", "9", "10"];

export const curriculumOptions: { value: string; label: string; description: string }[] = [
...
export const weightPresets: { label: string; ww: number; pt: number; qa: number }[] = [
