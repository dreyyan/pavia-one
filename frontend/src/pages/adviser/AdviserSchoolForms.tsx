    ...
    const fetchSections = async () => {
      ...
      try {
        ...
        if (!data.success) {
          ...
          const statuses = ["Complete", "Pending", undefined];
          const sectionsWithDefaults: Section[] = data.data.map((sec: any) => ({
            ...
            sf1_status: statuses[Math.floor(Math.random() * statuses.length)],
            sf2_status: statuses[Math.floor(Math.random() * statuses.length)],
            sf5_status: statuses[Math.floor(Math.random() * statuses.length)],
          }));
        ...
        {!loading &&
          ...
          filteredClasses.map((cls) => (
            <ClassCard
              ...
              color={cls.color}
              sf1_status={cls.sf1_status}
              sf2_status={cls.sf2_status}
              sf5_status={cls.sf5_status}
            />
          ))}
