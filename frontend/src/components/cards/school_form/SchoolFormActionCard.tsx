...
// [COMPONENT] Section-level school form action card — no student logic
const SchoolFormActionCard = ({
  ...
  return (
    <div className="bg-[var(--color-bg-50)] border border-[var(--color-bg-200)] rounded-md overflow-hidden">
      ...
      {/* [HEADER] Form type badge + status pill */}
      ...
      <div className="px-4 py-3 space-y-3">
        ...
        <div className="space-y-1 text-xs font-roboto text-[var(--color-text-600)]">
          {form.generatedAt && (
            <p>
              Generated:{" "}
              {new Date(form.generatedAt).toLocaleDateString("en-PH", {
                year: "numeric",
                month: "long",
                day: "numeric",
              })}
          ...
          {form.submittedAt && (
            <p>
              Submitted:{" "}
              {new Date(form.submittedAt).toLocaleDateString("en-PH", {
                year: "numeric",
                month: "long",
                day: "numeric",
              })}
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            <img src="/export.svg" alt="" className="size-4" />
            {exporting ? "Exporting..." : `Export ${form.type}`}
          </button>

          {/* [ACTION] Import — SF1 only */}
          {supportsImport && onImport && (
            ...
            >
              <img src="/import.svg" alt="" className="size-4" />
