...
const Dropdown: React.FC<DropdownProps> = ({
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={onToggle}
        className="relative flex items-center justify-center sm:justify-start gap-2 rounded-sm px-3 sm:px-4 md:px-5 h-10 transition cursor-pointer bg-[var(--color-bg-50)] hover:opacity-80"
      >
